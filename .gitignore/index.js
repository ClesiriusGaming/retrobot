...
client.on("ready", () => {
    ...
    client.user.setGame("c!help I Ecoute 7 serveurs");
});
...
client.on('message', message => { 
    ...
    if(message.content === prefix + "help"){
        ...
        .setDescription("Je suis un bot qui peut tous faire Voici mes commandes disponible !")
        .addField("c!help", "Affiche les commandes du bot")
        .addField("Bonjour", "Le bot répond !")
        .addField("Bonsoir", "Le bot dit Bonsoir !")
        .addField("c!info", "Donne des informations sur le bot et le serveur !")
        .addField("c!kick", "Kick l'utilisateur !")
        .addField("c!ban", "Ban l'utilisateur !")
        .addField("c!clear", "Surpprime le nombre de message indiqué")
        .addField("c!mute", "Permet de mute une personne !")
        .addField("c!unmute", "Permet de unmute une personne !")
        .addField("c!warn", "Permet de warn une personne ! HS")
